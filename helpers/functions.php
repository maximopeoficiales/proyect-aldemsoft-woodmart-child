...
{
     return get_stylesheet_directory_uri() . "/helpers/public/imgs/$name";
}
/**
...
{
     return get_stylesheet_directory_uri() . "/helpers/public/js/$name";
}
/**
...
require aldem_get_directory_helper() . "querys/reports.php";
require aldem_get_directory_helper() . "routes/security-rest.php";
